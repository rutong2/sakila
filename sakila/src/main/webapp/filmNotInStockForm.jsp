...
<body>
	<div class="container bg-dark">
		...
		<h1 class="text-center text-white">filmNotInStock</h1>
		<form method="post" action="filmNotInStockAction.jsp">
			<table class="table table-bordered text-center table-striped table-dark">
				...
				<tr>
					<td colspan="4"><button type="submit" class="btn btn-primary float-right">렌탈된 영화 확인</button></td>
				</tr>
			</table>
		</form>
	</div>
